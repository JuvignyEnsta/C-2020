...
int main()
{
    rationnel sqrt2{std::sqrt(2.), 1.E-14};
    ...
    std::cout << "cos( π/3 ) = " <<  std::string(rationnel{std::cos(πs3)}) << std::endl << std::flush;
    ...
    std::complex<rationnel> z1(rationnel{1LL,2}, rationnel{std::sqrt(3.)/2.,1.E-3});
