...
int main()
{
    rationnel<std::int64_t> sqrt2{std::sqrt(2.), 1.E-14};
    ...
    std::complex<rationnel<std::int64_t>> z1(rationnel<std::int64_t>{1LL,2LL}, rationnel<std::int64_t>{std::sqrt(3.)/2.,1.E-3});
